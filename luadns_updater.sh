...
RECORD_DETAILS=$(curl -u "$USER_EMAIL":"$API_TOKEN" -H 'Accept: application/json' "$API_URL")
...
UPDATE_RESPONSE=$(curl -u "$USER_EMAIL":"$API_TOKEN" -H  'Accept: application/json' -X PUT -d "$DATA" "$API_URL")
